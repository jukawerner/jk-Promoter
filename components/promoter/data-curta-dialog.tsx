...
interface DataCurtaDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export function DataCurtaDialog({ isOpen, onClose, onConfirm }: DataCurtaDialogProps) {
  ...
  const handleConfirm = () => {
    ...
    // Navegar para a página de Estoque Loja
    router.push("/promotor/pdv/estoque");
  };
